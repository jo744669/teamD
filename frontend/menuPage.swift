...
struct menuPage: View {
    ...
    let menuItems: [String: [MenuItem]] = [
        "Auntie Annes": [
            MenuItem(name: "Classic Pretzel", price: 4.29, description: "A soft pretzel"),
            MenuItem(name: "Pretzel Dogs", price: 4.99, description: "Pretzel dogs"),
            MenuItem(name: "Mini Dogs", price: 6.59, description: "Mini Dogs"),
            MenuItem(name: "Nuggest Cup - Original", price: 5.79, description: "Original Nuggets Cup"),
            MenuItem(name: "Nuggets Cup - Cinnamon Sugar", price: 5.89, description: "Cinnamon Nuggets Cup"),
            MenuItem(name: "Nuggets Cup - Pepperoni", price: 6.59, description: "Pepperoni Nuggets Cup"),
            MenuItem(name: "Nuggets Bucket - Original", price: 26.99, description: "Original Nuggets Bucket"),
            MenuItem(name: "Nuggets Bucket - Cinnamon", price: 27.99, description: "Cinnamon Nuggets Bucket"),
            MenuItem(name: "Nuggets Bucket - Pepperoni", price: 32.99, description: "Pepperoni Nuggets Bucket"),
            //toppings
            MenuItem(name: "Caramel", price: 1.19, description: "Topping"),
            MenuItem(name: "Cheese", price: 1.19, description: "Topping"),
            MenuItem(name: "Cream Cheese", price: 1.19, description: "Topping"),
            MenuItem(name: "HoneyMustard", price: 1.19, description: "Topping"),
            MenuItem(name: "Hot Salsa Cheese", price: 1.19, description: "Topping"),
            MenuItem(name: "Marinara", price: 1.19, description: "Topping"),
            //drinks
            ...
            MenuItem(name: "Medium Fountan Drink", price: 2.99, description: "Medium Fountan Drink"),
            MenuItem(name: "Large Fountan Drink", price: 3.29, description: "Large Fountan Drink"),
        ...
        "Burgers and Fries": [
            ...
            MenuItem(name: "Burger with Cheese", price: 5.99, description: "Burger and Cheese"),
            MenuItem(name: "Burger with Bacon and Cheese", price: 6.49, description: "Bacon and Cheese Burger"),
            MenuItem(name: "Burger with Avocado and PepperJack", price: 6.49, description: "Avocado Pepper Jack Burger"),
            MenuItem(name: "Double Burger with Cheese", price: 6.49, description: "Double Burger and Cheese"),
            MenuItem(name: "Chipolte Black Bean and Cheese", price: 7.09, description: "Chipolte Black Bean Burger and Cheese"),
            ...
            MenuItem(name: "Beyond and Cheese Burger", price: 9.49, description: "Beyond Burger and Cheese"),
            ...
            MenuItem(name: "Crispy Chicken Strips (3)", price: 4.59, description: "Three Crispy Chicken Strips"),
            MenuItem(name: "Crispy Chicken Strips (5)", price: 7.29, description: "Five Crispy Chicken Strips"),
            //combos
            MenuItem(name: "Grilled Chicken and Bacon Combo", price: 10.19, description: "Grilled Chicken and Bacon Combo"),
            MenuItem(name: "Tender Sandwich Combo", price: 8.29, description: "Tender and Sandwich Combo"),
            MenuItem(name: "Chipolte Black Bean and Cheese Combo", price: 10.59, description: "Chipolte Black Bean Burger and Cheese Combo"),
            MenuItem(name: "Burger with Bacon and Cheese Combo", price: 10.09, description: "Bacon and Cheese Burger Combo"),
            MenuItem(name: "Burger with Avocado Pepper Jack Combo", price: 10.09, description: "Avocado Pepper Jack Burger Combo"),
            MenuItem(name: "Burger with Cheese Combo", price: 9.29, description: "Burger and Cheese Combo"),
            MenuItem(name: "Chicken Cheesesteak Combo", price: 7.29, description: "Chicken Cheesesteak Combo"),
            MenuItem(name: "Double Burger with Cheese Combo", price: 12.09, description: "Double Burger and Cheese Combo"),
            ...
            MenuItem(name: "Crispy Chicken Strips (3) Combo", price: 4.59, description: "Three Crispy Chicken Strips Combo"),
            MenuItem(name: "Crispy Chicken Strips (5) Combo", price: 7.29, description: "Five Crispy Chicken Strips Combo"),
            //sides
        ...
        "Hawk Wrap": [
            MenuItem(name: "Classic", price: 6.85, description: "Classic wrap"),
            MenuItem(name: "Double Classic", price: 8.85, description: "Double classic wrap"),
            MenuItem(name: "Spicy", price: 6.85, description: "Spicy Hawk Wrap"),
            MenuItem(name: "Double Spicy", price: 8.85, description: "Double Spicy Wrap"),
            MenuItem(name: "Grilled Chicken", price: 6.85, description: "Grilled Chicken Wrap"),
            MenuItem(name: "Buffalo Chicken", price: 6.85, description: "Buffalo Chicken Wrap"),
            MenuItem(name: "Chicken Caesar", price: 6.85, description: "Chicken Caesar Wrap"),
            MenuItem(name: "Vegan", price: 6.85, description: "Vegan Hawk Wrap"),
            //sides
        ...
        "Jamba Juice": [
            MenuItem(name: "Bold n Cold Brew", price: 7.39, description: "old Brew, Ice, Agave, Caffeine"),
            MenuItem(name: "Caribbean Passion", price: 7.89, description: "Pear, White Grape, Mango, Orange Sherbert, Strawberries, Peaches, Orange Passion Juice Blend"),
            ...
            MenuItem(name: "Orange Booster", price: 8.99, description: "Orange Juice, Orange Sherbert, Peaches, Bananas, Daily Vitamin & Zinc Boost"),
            MenuItem(name: "Greens N Ginger", price: 8.69, description: "Lemonade, Kale, Peaches, Mango, Ginger"),
            MenuItem(name: "PB Choclate Love", price: 7.89, description: "Milk, Bananas, Chocolate, Peanut Butter, Moo'd Dairy Base"),
            ...
            MenuItem(name: "PB Banana Protein Soy", price: 8.99, description: "Soymilk, Acai, Grape Juice Blend, Strawberries, Blueberries, Raspberry Sherbert, Daily Vitamin & Zinc Boost"),
            ...
            MenuItem(name: "Smooth Talkin Mango", price: 8.99, description: "Oatmilk, Mango, Pineapple, Organic Agave"),
            MenuItem(name: "Peanut Butter Moo", price: 8.69, description: "Fat-Free Vanilla Frozen Yogurt, Vanilla, Soymilk, Milk, Bananas, Peanut Butter, Chocolate, Moo'd Dairy Base"),
